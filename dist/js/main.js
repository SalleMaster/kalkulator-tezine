...
//   var tipMaterijala = document.getElementById('tipMaterijala2').value;
//   var sirina = document.getElementById('sirina2').value;
//   var debljina = document.getElementById('debljina2').value;
//   var duzina = document.getElementById('duzina2').value;
//   var rezultat =
//     (kolicina * (sirina * debljina) * (duzina / 1000) * tipMaterijala) /
//     1000000;
...
//   var kolicina = document.getElementById('kolicina3').value;
//   var tipMaterijala = document.getElementById('tipMaterijala3').value;
//   var sirina = document.getElementById('sirina3').value;
//   var duzina = document.getElementById('duzina3').value;
//   var rezultat =
//     (kolicina * (sirina * sirina * 0.866) * (duzina / 1000) * tipMaterijala) /
//     1000000;
...
// }
// function okrugleCevi() {
//   var kolicina = document.getElementById('kolicina4').value;
//   var tipMaterijala = document.getElementById('tipMaterijala4').value;
//   var precnik1 = document.getElementById('precnik14').value / 2;
//   var precnik2 = precnik1 - document.getElementById('precnik24').value;
//   var duzina = document.getElementById('duzina4').value;
//   var rezultat =
//     (kolicina *
//       (precnik1 * precnik1 * Math.PI - precnik2 * precnik2 * Math.PI) *
//       (duzina / 1000) *
...
//     1000000;
//   rezultat = Math.round(rezultat * 100) / 100;
//   document.getElementById('rezultat4').value = rezultat;
// }
// function pravougaoneCevi() {
//   var kolicina = document.getElementById('kolicina5').value;
//   var tipMaterijala = document.getElementById('tipMaterijala5').value;
//   var sirina = document.getElementById('sirina5').value;
//   var visina = document.getElementById('visina5').value;
//   var debljina = document.getElementById('debljina5').value;
//   var duzina = document.getElementById('duzina5').value;
//   var rezultat =
//     ((2 * sirina + 2 * visina - 4 * debljina) / 1000) *
//     debljina *
//     (duzina / 1000) *
...
//     kolicina;
//   rezultat = Math.round(rezultat * 100) / 100;
//   document.getElementById('rezultat5').value = rezultat;
// }
